...
public class PaymentSummaryDetailSearch {
	private int paymentSummaryId;
	private String paymentSummaryName;
	...
	public int getPaymentSummaryId() {
		return paymentSummaryId;
	}

	public void setPaymentSummaryId(int paymentSummaryId) {
